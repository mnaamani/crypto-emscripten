...
${EMSCRIPTEN}/emconfigure ./configure --prefix=${BASEDIR} --with-gpg-error-prefix=${BASEDIR} --disable-asm --disable-pclmul-support --disable-neon-support --disable-arm-crypto-support --disable-doc --enable-shared --disable-static --host=x86-unknown-linux --enable-ciphers="${SYMMETRIC_CYPHERS}" "CFLAGS=-m32"
