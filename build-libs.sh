...
BASEDIR=$(dirname $(pwd))
${EMSCRIPTEN}/emconfigure ./configure --prefix=${BASEDIR} --enable-static --disable-shared --disable-nls --disable-threads --disable-doc --build=x86-unknown-linux --host=x86-unknown-linux "CFLAGS=-m32"
